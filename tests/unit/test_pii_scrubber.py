...
class TestPIIScrubber:
    ...
    def test_parenthesized_phone_no_space_after_area_code(self, scrubber: PIIScrubber) -> None:
        """Test parenthesized US phone number with no space before the exchange
        (regression for the (?<!\\w) lookbehind fix on phone_us, issue #146)."""
