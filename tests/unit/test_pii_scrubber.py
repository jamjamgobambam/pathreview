...
class TestPIIScrubber:
    ...
    def test_phone_number_partially_formatted_redaction(self, scrubber: PIIScrubber) -> None:
        """Test that US phone numbers with mixed delimiters (e.g., parens + dots)

        are correctly detected and redacted.
        """
        text = "Reach support at (800).555.0199 today."
        scrubbed = scrubber.scrub(text)
        detected = scrubber.detect(text)
