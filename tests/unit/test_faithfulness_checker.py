...
class TestFaithfulnessChecker:
    ...
    def test_feedback_with_no_support_in_context(self, checker: FaithfulnessChecker) -> None:
        ...
        assert isinstance(score, float)
        assert score <= 0.5  # The heuristic remains low-to-mid for this mismatch
    ...
    def test_empty_feedback_returns_zero(self, checker: FaithfulnessChecker) -> None:
        ...
        feedback = ""
        context_chunks: list[ContextChunk] = [{"text": "Some context"}]
    ...
    def test_common_words_filtered_in_overlap(self, checker: FaithfulnessChecker) -> None:
        ...
        _ = checker._is_supported(claim, context)
    ...
    def test_developer_term_is_not_treated_as_noise(self, checker: FaithfulnessChecker) -> None:
        """Test that developer-related terms count as meaningful overlap."""
        feedback = "Developer experience matters"
        context_chunks = [{"text": "Developer experience is essential"}]
