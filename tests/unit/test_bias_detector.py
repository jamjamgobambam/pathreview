...
class TestBiasDetector:
    ...
    def test_clean_feedback_not_flagged(self):
        ...
        text = (
            "You have demonstrated strong Python skills. Your code is well-organized and "
    ...
    def test_comparative_without_bias(self):
        ...
        text = (
            "Your bootcamp education covers practical skills. University education provides "
            "theory. Both have value."
        )
