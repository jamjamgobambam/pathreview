...
class TestResumeParser:
    ...
    def test_parse_pdf_with_indented_sections(self, parser: ResumeParser) -> None:
        """Regression test for issue #147: section headers indented in
        PDF-extracted text (a common artifact of column-based PDF layouts)
        should still be detected, not just flush-left headers."""
        with patch("ingestion.parsers.resume_parser.PdfReader") as mock_pdf_reader:
            mock_page = Mock()
