...
class HybridRetriever:
    ...
    def retrieve(
        ...
        for chunk_id in all_ids:
            ...
            # Scale the keyword contribution by semantic relevance so a chunk that
            # only repeats a common technology term cannot outrank a chunk the query
            # is actually about. Chunks strong in both searches keep the full boost.
            blended_score = (
