...
class FaithfulnessChecker:
    ...
    def check(self, feedback: str, context_chunks: list[dict]) -> float:
        ...
        # Concatenate context text. Use `or ""` so a chunk whose "text" is
        # present but None (not just missing) is treated as empty rather than
        # passing None into str.join, which would raise a TypeError.
