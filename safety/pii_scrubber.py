...
class PIIScrubber:
    ...
    PII_PATTERNS = {
        ...
        # Lookarounds preserve surrounding text and allow a match to start with "(".
        "phone_us": (
            r"(?<![\w+])(?:\+?1[ .-]?)?"
            r"(?:\([0-9]{3}\)|(?<!\()[0-9]{3})"
            r"[ .-]?[0-9]{3}[ .-]?[0-9]{4}(?!\w)"
        ...
        "street_address": (
            ...
            r"Circle|Cir|Park|Pl|Plaza|Place|Drive|Dr|Way|Parkway|Pkwy|Point|Pt|Pike|"
            r"Run|Summit|Summit|Terrace|Ter|Trail|Trl|Tunnel|Turnpike|View|Vista|Vlg|"
            r"Village|Vly|Valley)"
        ),
    }
