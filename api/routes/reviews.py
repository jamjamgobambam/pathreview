...
async def create_review_endpoint(
    ...
    try:
        ...
        if not review:
            log.warning(
                "review_profile_not_found_or_unauthorized",
        ...
        review_response = cast(ReviewResponse, ReviewResponse.model_validate(review))
...
async def list_reviews_endpoint(
    ...
    try:
        ...
        review_items = [cast(ReviewResponse, ReviewResponse.model_validate(r)) for r in reviews]
