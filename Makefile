...
run: ## Start backend + frontend dev servers
	...
	source $(VENV_BIN)/activate && uvicorn api.main:app --reload \
		--reload-dir api --reload-dir core --reload-dir ingestion \
		--reload-dir rag --reload-dir agent --reload-dir safety \
